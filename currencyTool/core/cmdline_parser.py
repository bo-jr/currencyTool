...
# make sure parse_commandline_args doesn't crash
...
def parse_commandline_args():
    ...
    argparser = ArgumentParser(prog='currency_converter',
        description=('Tool that shows exchange rated and perform currency convertion, using http://fixer.io data'))
    ...
    argparser.add_argument('--update',
                            ...
                            help=('Update the foreigner exchange rates using as a reference the base currency'))
    
    argparser.add_argument('--basecurrency',
                            type=str,
                            dest='from_currency',
                            choices=currency_options,
                            help=('The base currency. If specified it will override the default currency set by the --setbasecurrency option'))
    ...
    argparser.add_argument('--to',
                            ...
                            dest='dest_currency',
                            choices=currency_options,
                            help=('Specify the currency that the value will be converted to'))
